...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-8 mx-auto" style="border: 3px solid #4bb71b; border-radius: 36px;">
            <div class="row">
                ...
                <div class="col-12 text-center display-5" style="color: #4bb71b;">
...
<script>
    ...
    }, 5000); // Cambia el tiempo (en milisegundos) según tus necesidades, por ejemplo, 5000 ms = 5 segundos
</script>
